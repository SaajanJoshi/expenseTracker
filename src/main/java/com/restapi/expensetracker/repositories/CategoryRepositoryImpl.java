...
public class CategoryRepositoryImpl implements CategoryRepository {
	...
	@Override
	public List<Category> findAll(Integer userId) throws EtResourseNotFoundException {
		// TODO Auto-generated method stub
		return jdbcTemplate.query(SQL_FIND_ALL,new Object[] {userId},categoryRowMapper);
	}

	@Override
	public Category findById(Integer userId, Integer cartegoryId) throws EtBadRequestException {
		// TODO Auto-generated method stub
		try{
			return jdbcTemplate.queryForObject(SQL_FIND_BY_ID, new Object[] {userId,cartegoryId},categoryRowMapper); 
		} catch (Exception e) {
			throw new EtResourseNotFoundException("Category not found");
		}
	}
	...
	public Integer create(Integer userId, String title, String description) throws EtBadRequestException {
		...
		throw new EtBadRequestException ("Invalid detail, failed to create account");
	}
	}
